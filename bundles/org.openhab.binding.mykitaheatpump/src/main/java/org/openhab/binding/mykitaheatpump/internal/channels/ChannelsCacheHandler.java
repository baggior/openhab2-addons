 ...
 */
@NonNullByDefault
public class ChannelsCacheHandler {
    ...
    public ChannelsCacheHandler(MyKitaHeatPumpThingHandler myKitaHeatPumpHandler) {
    ...
    public void initialize() {
        ...
        List<Channel> channels = ChannelsBuilder.of(this.thingHandler.getKita(), this).build();
        this.thingHandler.updateThingChannels(channels);
